...
class DriftUserDao {
  ...
  Future<int> upsertUser(UserModel user) async {
    try {
      ...
      final mergedUser = existing.copyWith(
        ...
        profileSetupCompleted: user.profileSetupCompleted != 0 ? user.profileSetupCompleted : existing.profileSetupCompleted,
  ...
  UserModel _userFromDrift(User row) {
    return UserModel(
      ...
      profileSetupCompleted: row.profileSetupCompleted,
